...
function largestProductInSeries() {
    const string = "";
    let maxp = 0;

    for (let i = 0; i <= string.length - 13; i++) {
        let p = 1;
        for (let j = 0; j < 13; j++) {
            p *= parseInt(string[i+j]);
        }
        if (p > maxp) {
            maxp = p;
        }
